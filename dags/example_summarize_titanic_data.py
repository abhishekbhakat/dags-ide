...
@dag(
    ...
    schedule=None,
    start_date=pendulum.from_format("2023-12-19", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "abhishek.bhakat@astronomer.io": "mailto:abhishek.bhakat@astronomer.io",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clilt7vco00a601kk5fz65ob1/cloud-ide/cllqdh2py00fg01onbb7slrav/cllqdh398000n01paeetrlh00",
    },
)
